...
public class KabaneroRepositoryTest{
    ...
    public void codewindURLGeneratedCorrectly() {
        ...
        kabaneroInstance = new KabaneroInstance("mock kabanero username", instanceId , "10/03/2019", Arrays.asList(kabaneroRepository), "mock cluster", Arrays.asList(KabaneroStack), "https://mock-kabanero-cli-kabanero.mock.mock.ibm.com");
