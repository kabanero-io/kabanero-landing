...
public class ICPAInstanceDetails {
    ...
    public ICPAInstanceDetails(String username, String date, String collectionHub,String clusterName, Map<String, Collection> collections){
